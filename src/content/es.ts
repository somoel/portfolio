...
export const es: Dictionary = {
  ...
  footerNavAria: "Enlaces del sitio",
  logoAria: "Samuel Segura — inicio",
  hero: {
  ...
  skills: {
    ...
    projectsNote: "Usado en proyectos",
  ...
  contact: {
    ...
    copyEmailError: "No se pudo copiar automáticamente. Selecciona la dirección:",
    linkedinLabel: "LinkedIn",
    githubLabel: "GitHub",
    cvLabel: "Ver CV",
    cvHint:
      "Página lista para imprimir: usa la opción de impresión del navegador para guardarla como PDF.",
    footerNote:
